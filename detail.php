                ...
                <div class="row">
                    <div class="card-deck">
                        <div class="card col-lg-3 col-md-4 col-sm-12" style="">
                            <a href="detail.php?moc=<?php print($data_moc1['set_num']); ?>">
                                <img class="card-img-top" src=" <?php print($data_moc1['moc_img_url']) ?>" alt="Card image cap">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="card col-lg-3 col-md-4 col-sm-12" style="">
                        <a href="detail.php?nummer=<?php print($data_set1['set_num']); ?>">
                            <img class="card-img-top" src=" <?php print($data_set1['set_img_url']) ?>" alt="Card image cap">
                        </a>
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                <div class="set_num">
                                    <span>number: </span>
                                    <?php print($data_set1['set_num']); ?>
                                </div>
                                <div class="parts"><span> parts: </span>
                                    <?php print($data_set1['num_parts']); ?>
                                </div>
                                <div class="year">
                                    <span> year: </span>
                                    <?php print($data_set1['year']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card col-lg-3 col-md-4 col-sm-12" style="">
                        <a href="detail.php?moc=<?php print($data_moc2['set_num']); ?>">
                            <img class="card-img-top" src=" <?php print($data_moc2['moc_img_url']) ?>" alt="Card image cap">
                        </a>
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                <div class="set_num">
                                    <span>number: </span>
                                    <?php print($data_moc2['set_num']); ?>
                                </div>
                                <div class="parts">
                                    <span> parts: </span>
                                    <?php print($data_moc2['num_parts']); ?>
                                </div>
                    ...
                    <div class="card col-lg-3 col-md-4 col-sm-12" style="">
                        <a href="detail.php?nummer=<?php print($data_set2['set_num']); ?>">
                            <img class="card-img-top" src=" <?php print($data_set2['set_img_url']) ?>" alt="Card image cap">
                        </a>
                        <div class="card-body">
                            <h5 class="card-title"><?php print($data_moc1['name']); ?></h5>
                            <div class="card-text">
                                <div class="set_num">
                                    <span>number :</span>
                                    <?php print($data_set2['set_num']); ?>
                                </div>
                                <div class="parts">
                                    <span> parts: </span>
                                    <?php print($data_set2['num_parts']); ?>
                                </div>
                                <div class="year">
                                    <span> year: </span>
                                    <?php print($data_set2['year']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
